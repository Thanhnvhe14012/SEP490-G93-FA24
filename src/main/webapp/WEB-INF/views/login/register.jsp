    ...
    <form:form modelAttribute="user" method="POST" enctype="multipart/form-data" class="mt-4">
      ...
      <div id="employerFields" style="display:none;">
        ...
        <div class="mb-3">
          ...
          <img id="logo-preview" src="${company.logo}" alt="Company Logo" style="max-height: 100px; margin-bottom: 10px;" />
          <input id="image" type="file" class="form-control" name="image" accept="image/*" onchange="previewImage(event)" />
        </div>
      </div>
